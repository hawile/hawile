layui.define(['layer', 'carousel'], function (exports) {
    ...
    // 添加步骤条dom节点
    let renderDom = function (elem, stepItems, postion) {
        ...
        for (let i = 0; i < stepItems.length; i++) {
            ...
            // 标题和描述
            let title = stepItems[i].title;
            let desc = stepItems[i].desc;
            if (title || desc) {
