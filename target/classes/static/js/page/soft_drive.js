layui.use(['form','table','upload','element'],function(){
    ...
    table.on('tool(table)',function (obj){
        ...
        switch (obj.event) {
            ...
            break;
            case 'download':
                window.location="/soft_drive/download?download="+data.path+"&name="+data.name;
            break;
        }
    });
